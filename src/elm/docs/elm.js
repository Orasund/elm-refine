...
var $author$project$Data$Condition$emptyForm = {
	bigger: _Utils_Tuple2($elm$core$Array$empty, '[k1]_{}'),
	guards: $elm$core$Array$empty,
	smaller: _Utils_Tuple2($elm$core$Array$empty, 'True'),
	typeVariables: $elm$core$Array$empty
};
var $author$project$Page$Setup$init = {conditions: _List_Nil, error: $elm$core$Maybe$Nothing, form: $author$project$Data$Condition$emptyForm, loaded: false};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Setup($author$project$Page$Setup$init),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Page$Assistant$IncomingMsg = function (a) {
	return {$: 'IncomingMsg', a: a};
};
var $author$project$Page$Setup$IncomingMsg = function (a) {
	return {$: 'IncomingMsg', a: a};
};
var $author$project$Main$WhileAssistant = function (a) {
	return {$: 'WhileAssistant', a: a};
};
var $author$project$Main$WhileSetup = function (a) {
	return {$: 'WhileSetup', a: a};
};
var $author$project$Data$IncomingMsg$fromTuple = function (_v0) {
	var kind = _v0.a;
	var payload = _v0.b;
...
var $author$project$Main$incomingMsg = _Platform_incomingPort(
	'incomingMsg',
	A2(
...
var $author$project$Main$subscriptions = function (model) {
	switch (model.$) {
		case 'Setup':
			return $author$project$Main$incomingMsg(
				function (v) {
					return $author$project$Main$WhileSetup(
						$author$project$Page$Setup$IncomingMsg(
							$author$project$Data$IncomingMsg$fromTuple(v)));
				});
		case 'Assistant':
			return $author$project$Main$incomingMsg(
				function (v) {
					return $author$project$Main$WhileAssistant(
						$author$project$Page$Assistant$IncomingMsg(
							$author$project$Data$IncomingMsg$fromTuple(v)));
				});
		default:
...
var $author$project$Main$Assistant = function (a) {
	return {$: 'Assistant', a: a};
};
var $author$project$Main$Done = function (a) {
	return {$: 'Done', a: a};
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $Orasund$elm_action$Action$apply = function (_v0) {
	var action = _v0.a;
	var exitFun = _v0.b.exitFun;
	var modelMapper = _v0.b.modelMapper;
	var msgMapper = _v0.b.msgMapper;
	var transitionFun = _v0.b.transitionFun;
	switch (action.$) {
		case 'Exit':
			var exitAllowed = action.a;
			return exitFun(exitAllowed);
		case 'Transition':
			var transitionData = action.a;
			return transitionFun(transitionData);
		default:
			var _v2 = action.a;
			var stateModel = _v2.a;
			var stateMsg = _v2.b;
			return _Utils_Tuple2(
				modelMapper(stateModel),
				A2($elm$core$Platform$Cmd$map, msgMapper, stateMsg));
	}
};
var $Orasund$elm_action$Action$config = function (action) {
	return _Utils_Tuple2(
		action,
		{exitFun: $elm$core$Basics$never, modelMapper: $elm$core$Basics$never, msgMapper: $elm$core$Basics$never, transitionFun: $elm$core$Basics$never});
};
...
var $author$project$Data$Refinement$EitherOr = F2(
	function (a, b) {
...
var $author$project$Data$Refinement$IsBigger = F2(
	function (a, b) {
		return {$: 'IsBigger', a: a, b: b};
	});
var $author$project$Data$Refinement$IsEqual = F2(
	function (a, b) {
		return {$: 'IsEqual', a: a, b: b};
	});
var $author$project$Data$Refinement$IsNot = function (a) {
	return {$: 'IsNot', a: a};
};
var $author$project$Data$Refinement$IsSmaller = F2(
	function (a, b) {
...
var $author$project$Page$Assistant$init = function (conditions) {
	var initList = $author$project$Data$Refinement$init(
			...
			predicates: $elm$core$Dict$fromList(
				A2(
					...
					function (v) {
						return _Utils_Tuple2(
							v,
							$elm$core$Array$fromList(initList));
					},
					A2($elm$core$List$concatMap, $author$project$Data$Condition$liquidTypeVariables, conditions))),
			weaken: $elm$core$Maybe$Nothing
		},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Data$Refinement$AndAlso = F2(
	function (a, b) {
		return {$: 'AndAlso', a: a, b: b};
	});
var $author$project$Data$Refinement$IsTrue = {$: 'IsTrue'};
var $author$project$Data$Refinement$conjunction = function (l) {
	if (!l.b) {
		return $author$project$Data$Refinement$IsTrue;
	} else {
		var head = l.a;
		var tail = l.b;
		return A3($elm$core$List$foldl, $author$project$Data$Refinement$AndAlso, head, tail);
	}
};
					...
					_Utils_Tuple2(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								sendMsg,
								$author$project$Page$Assistant$smtStatement(model)))));
		}
	});
...
var $author$project$Data$Condition$addBigger = function (form) {
...
var $author$project$Data$Condition$addGuard = function (form) {
	return _Utils_update(
		form,
		{
			guards: A2(
...
var $author$project$Data$Condition$addSmaller = function (form) {
	return _Utils_update(
		form,
		{
			smaller: A2(
...
var $author$project$Data$Condition$addTypeVariable = function (form) {
	return _Utils_update(
		form,
		{
			typeVariables: A2(
					...
					_List_fromArray(
						[
							...
							'a' + $elm$core$String$fromInt(
								$elm$core$Array$length(form.typeVariables)),
							'True')
						])))
		});
};
...
var $author$project$Data$Condition$Condition = F4(
	function (smaller, bigger, guards, typeVariables) {
		return {bigger: bigger, guards: guards, smaller: smaller, typeVariables: typeVariables};
	});
var $author$project$Data$Refinement$problemToString = function (p) {
	switch (p.$) {
		case 'Expecting':
			var s = p.a;
			return 'expecting \'' + (s + '\'');
...
var $author$project$Data$Refinement$deadEndToString = function (deadend) {
	return $author$project$Data$Refinement$problemToString(deadend.problem) + (' at row ' + ($elm$core$String$fromInt(deadend.row) + (', col ' + $elm$core$String$fromInt(deadend.col))));
};
...
var $author$project$Data$Refinement$deadEndsToString = function (deadEnds) {
	return $elm$core$String$concat(
		A2(
			...
			[
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Data$Refinement$IsSmaller),
							$elm$parser$Parser$keyword('(<)')),
						$elm$parser$Parser$spaces),
					A2(
						$elm$parser$Parser$ignorer,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Data$Refinement$IsBigger),
							$elm$parser$Parser$keyword('(>)')),
						$elm$parser$Parser$spaces),
					A2(
						$elm$parser$Parser$ignorer,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Data$Refinement$IsEqual),
							$elm$parser$Parser$keyword('(==)')),
						$elm$parser$Parser$spaces),
					A2(
						$elm$parser$Parser$ignorer,
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Data$Refinement$EitherOr),
					...
					A2(
						...
						$elm$parser$Parser$lazy(
							function (_v2) {
								return $author$project$Data$Refinement$cyclic$decoder();
							}),
						$elm$parser$Parser$spaces)),
				$elm$parser$Parser$lazy(
					function (_v3) {
				...
				A2(
					...
					A2(
						...
						A2(
							$elm$parser$Parser$ignorer,
							$elm$parser$Parser$succeed($author$project$Data$Refinement$AndAlso),
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$Data$Refinement$IsNot),
...
try {
	var $author$project$Data$Refinement$decoder = $author$project$Data$Refinement$cyclic$decoder();
	$author$project$Data$Refinement$cyclic$decoder = function () {
		return $author$project$Data$Refinement$decoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `Data.Refinement` are causing infinite recursion:\n\n  ┌─────┐\n  │    decoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Data$Refinement$decode = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run($author$project$Data$Refinement$decoder),
	$elm$core$Result$mapError($author$project$Data$Refinement$deadEndsToString));
...
var $author$project$Data$Template$decoder = function () {
	var item = A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
	...
	return A2(
		...
		$elm$parser$Parser$sequence(
			{end: '}', item: item, separator: ',', spaces: $elm$parser$Parser$spaces, start: ']_{', trailing: $elm$parser$Parser$Forbidden}));
}();
var $author$project$Data$Template$decode = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run($author$project$Data$Template$decoder),
	$elm$core$Result$mapError($author$project$Data$Refinement$deadEndsToString));
var $author$project$Data$LiquidType$IntType = function (a) {
	return {$: 'IntType', a: a};
};
var $author$project$Data$LiquidType$LiquidTypeVariable = function (a) {
	return {$: 'LiquidTypeVariable', a: a};
};
var $author$project$Data$LiquidType$decodeSimpleLiquidType = A2(
	$elm$core$Basics$composeR,
	$elm$parser$Parser$run(
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					A2($elm$parser$Parser$map, $author$project$Data$LiquidType$IntType, $author$project$Data$Refinement$decoder),
					A2($elm$parser$Parser$map, $author$project$Data$LiquidType$LiquidTypeVariable, $author$project$Data$Template$decoder)
				]))),
	$elm$core$Result$mapError($author$project$Data$Refinement$deadEndsToString));
...
var $author$project$Data$Condition$decode = function (_v0) {
	var smaller = _v0.smaller;
	var bigger = _v0.bigger;
	var guards = _v0.guards;
	var typeVariables = _v0.typeVariables;
		...
		function (_v3) {
			...
			return A3(
				...
				A2(
					...
					$author$project$Data$Refinement$deadEndsToString,
					A2($elm$parser$Parser$run, $author$project$Data$Template$decoder, head)));
		}(bigger),
		$elm_community$result_extra$Result$Extra$combine(
			$elm$core$Array$toList(
				A2($elm$core$Array$map, $author$project$Data$Refinement$decode, guards))),
		function (_v5) {
			var keys = _v5.a;
			var values = _v5.b;
			return A2(
				$elm$core$Result$map,
				$elm_community$list_extra$List$Extra$zip(keys),
				$elm_community$result_extra$Result$Extra$combine(values));
		}(
			$elm$core$List$unzip(
				$elm$core$Array$toList(
					A2(
	...
	return _Utils_update(
		form,
		{
			bigger: A2(
				$elm$core$Tuple$mapFirst,
				function (l) {
					return A2($elm_community$array_extra$Array$Extra$removeAt, 0, l);
				},
				form.bigger)
		});
};
var $author$project$Data$Condition$removeGuard = function (form) {
	return _Utils_update(
		form,
		{
			guards: A2(
				$elm_community$array_extra$Array$Extra$removeAt,
				(-1) + $elm$core$Array$length(form.guards),
				form.guards)
		});
};
var $author$project$Data$Condition$removeSmaller = function (form) {
	return _Utils_update(
		form,
		{
			smaller: A2(
...
var $author$project$Data$Condition$removeTypeVariable = function (form) {
	return _Utils_update(
		form,
		{
			typeVariables: A2(
				$elm_community$array_extra$Array$Extra$removeAt,
				(-1) + $elm$core$Array$length(form.typeVariables),
				form.typeVariables)
		});
};
...
var $author$project$Data$Condition$setBigger = F3(
	function (index, value, form) {
		return _Utils_update(
			form,
			{
				bigger: (_Utils_eq(
					index,
					$elm$core$Array$length(form.smaller.a)) ? $elm$core$Tuple$mapSecond(
					$elm$core$Basics$always(value)) : $elm$core$Tuple$mapFirst(
					A2(
...
var $author$project$Data$Condition$setGuard = F3(
	function (index, value, form) {
		return _Utils_update(
			form,
			{
				guards: A3($elm$core$Array$set, index, value, form.guards)
			});
	});
var $author$project$Data$Condition$setSmaller = F3(
	function (index, value, form) {
		return _Utils_update(
			form,
			{
...
var $author$project$Data$Condition$setTypeVariableName = F3(
	function (index, value, form) {
		return _Utils_update(
			form,
			{
...
var $author$project$Data$Condition$setTypeVariables = F3(
	function (index, value, form) {
		return _Utils_update(
			form,
			{
				typeVariables: A3(
					...
					function (_v0) {
						var k = _v0.a;
						return _Utils_Tuple2(k, value);
					},
					form.typeVariables)
			});
	});
var $author$project$Data$Condition$setVariable = F3(
	function (index, value, form) {
		var fun = _Utils_eq(index, -1) ? $elm$core$Tuple$mapSecond(
			$elm$core$Basics$always(value)) : $elm$core$Tuple$mapFirst(
			A2(
				$elm_community$array_extra$Array$Extra$update,
				index,
...
var $author$project$Data$Algorithm$split = function () {
	var rec = F2(
		function (offset, condition) {
			var _v0 = _Utils_Tuple2(condition.smaller, condition.bigger);
			_v0$2:
			while (true) {
				if (_v0.a.a.b) {
					if (_v0.b.a.b) {
						...
						var t4 = _v4.b;
						var t4end = _v3.b;
						return _Utils_eq(q1.name, q3.name) ? A2(
							$elm$core$Result$map,
							$elm$core$List$cons(
								{
									bigger: q1.baseType,
					...
					if (!_v0.b.a.b) {
						...
						return $elm$core$Result$Ok(
							_List_fromArray(
								[
									{bigger: q2, guards: condition.guards, smaller: q1, typeVariables: condition.typeVariables}
								]));
					} else {
						break _v0$2;
					}
				...
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								conditions: A2($elm$core$List$drop, 1, model.conditions)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedBigger':
				var index = msg.a;
				...
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setBigger, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedSmaller':
				var index = msg.a;
				...
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setSmaller, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedVariable':
				var index = msg.a;
				var string = msg.b;
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setVariable, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedGuard':
				var index = msg.a;
				...
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setGuard, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedTypeVariables':
				var index = msg.a;
				var string = msg.b;
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setTypeVariables, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'ChangedTypeVariableName':
				var index = msg.a;
				var string = msg.b;
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: A3($author$project$Data$Condition$setTypeVariableName, index, string, model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'AddType':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$addBigger(
									$author$project$Data$Condition$addSmaller(model.form))
							}),
						$elm$core$Platform$Cmd$none));
			case 'RemoveType':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$removeBigger(
									$author$project$Data$Condition$removeSmaller(model.form))
							}),
						$elm$core$Platform$Cmd$none));
			case 'AddGuard':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$addGuard(model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'RemoveGuard':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$removeGuard(model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'AddTypeVariable':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$addTypeVariable(model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'RemoveTypeVariable':
				return $Orasund$elm_action$Action$updating(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								form: $author$project$Data$Condition$removeTypeVariable(model.form)
							}),
						$elm$core$Platform$Cmd$none));
			case 'StartProving':
					...
					return $Orasund$elm_action$Action$updating(
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
									error: $elm$core$Maybe$Just('variables names are not the same')
								}),
							$elm$core$Platform$Cmd$none));
				}
			default:
...
var $Orasund$elm_action$Action$map = function (fun) {
	return $elm$core$Tuple$mapSecond(fun);
};
var $Orasund$elm_action$Action$withCustomTransition = function (a) {
	return $Orasund$elm_action$Action$map(
		function (_v0) {
			var exitFun = _v0.exitFun;
			var modelMapper = _v0.modelMapper;
			var msgMapper = _v0.msgMapper;
			var transitionFun = _v0.transitionFun;
			return {exitFun: exitFun, modelMapper: modelMapper, msgMapper: msgMapper, transitionFun: a};
		});
};
var $Orasund$elm_action$Action$withTransition = F3(
	function (a, mapState, mapMsg) {
		return $Orasund$elm_action$Action$withCustomTransition(
			A2(
				$elm$core$Basics$composeR,
				a,
				function (_v0) {
					...
					return _Utils_Tuple2(
						mapState(s),
						A2($elm$core$Platform$Cmd$map, mapMsg, c));
				}));
	});
var $Orasund$elm_action$Action$withUpdate = F2(
	function (a, b) {
		return $Orasund$elm_action$Action$map(
			function (_v0) {
				var exitFun = _v0.exitFun;
				...
				var msgMapper = _v0.msgMapper;
				var transitionFun = _v0.transitionFun;
				return {exitFun: exitFun, modelMapper: a, msgMapper: b, transitionFun: transitionFun};
			});
	});
...
var $author$project$Page$Assistant$AskSMT = {$: 'AskSMT'};
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$accessibleTextColor = function (color) {
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity = function (opacity) {
	return A2(
		$elm$core$Basics$composeR,
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow = function (_float) {
	return {
		blur: _float,
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$cardColumn = function (palette) {
	return {
			...
			[
				...
				_List_fromArray(
					[
						...
						$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(4))
					])),
		...
		element: _List_fromArray(
			[
				...
				$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$accessibleTextColor(palette.surface))),
				$mdgriffith$elm_ui$Element$Border$color(
				$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
					A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.14, palette.on.surface))),
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Typography$button = _List_fromArray(
	[
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$baseButton = function (_v0) {
	return {
		container: _Utils_ap(
			$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$button,
			_List_fromArray(
				[
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonDisabledOpacity = 0.38;
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonFocusOpacity = 0.24;
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonHoverOpacity = 0.08;
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonPressedOpacity = 0.32;
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$gray = A3($avh4$elm_color$Color$rgb255, 119, 119, 119);
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$fromCIELCH = A2(
	$elm$core$Basics$composeR,
	function (_v0) {
		var l = _v0.l;
		var c = _v0.c;
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$toCIELCH = A2(
	$elm$core$Basics$composeR,
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade = F3(
	function (c2, amount, c1) {
		...
		return $avh4$elm_color$Color$fromRgba(
			function (color) {
				...
				$avh4$elm_color$Color$toRgba(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$fromCIELCH(
						A2(
							fun,
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$toCIELCH(c1),
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$toCIELCH(c2))))));
	});
	...
	return {
		container: _Utils_ap(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Border$shadow(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(2)),
					$mdgriffith$elm_ui$Element$mouseDown(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade, palette.on.primary, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonPressedOpacity, palette.primary))),
							$mdgriffith$elm_ui$Element$Border$shadow(
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(12))
						])),
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade, palette.on.primary, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonFocusOpacity, palette.primary))),
							$mdgriffith$elm_ui$Element$Border$shadow(
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(6))
						])),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A3($Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade, palette.on.primary, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonHoverOpacity, palette.primary))),
							$mdgriffith$elm_ui$Element$Border$shadow(
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(6))
						]))
				])),
		ifActive: _List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Font$color(
				$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$accessibleTextColor(palette.primary)))
			]),
		ifDisabled: _Utils_ap(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
						A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonDisabledOpacity, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$gray))),
					$mdgriffith$elm_ui$Element$Font$color(
					$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor($Orasund$elm_ui_widgets$Widget$Style$Material$Color$gray)),
					$mdgriffith$elm_ui$Element$Border$shadow(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(0)),
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h5 = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$size(24)
	]);
var $Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h6 = _List_fromArray(
	[
		...
		container: _Utils_ap(
			...
			_List_fromArray(
				[
					...
					$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
						A3(
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade,
							palette.primary,
							$Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonHoverOpacity,
							A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.14, palette.on.surface)))),
					$mdgriffith$elm_ui$Element$mouseDown(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonPressedOpacity, palette.primary)))
						])),
					$mdgriffith$elm_ui$Element$focused(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonFocusOpacity, palette.primary)))
						])),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
								A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonHoverOpacity, palette.primary)))
						]))
				])),
		ifActive: _List_fromArray(
			[
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Typography$subtitle2 = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Font$size(14),
		$mdgriffith$elm_ui$Element$Font$semiBold,
...
var $author$project$Data$Refinement$toString = function (refinement) {
	switch (refinement.$) {
		case 'IsTrue':
			return 'True';
		case 'IsFalse':
		...
		case 'EitherOr':
			var r1 = refinement.a;
			var r2 = refinement.b;
			return 'Or (' + ($author$project$Data$Refinement$toString(r1) + (') (' + ($author$project$Data$Refinement$toString(r2) + ')')));
		case 'AndAlso':
			var r1 = refinement.a;
			var r2 = refinement.b;
			return 'And (' + ($author$project$Data$Refinement$toString(r1) + (') (' + ($author$project$Data$Refinement$toString(r2) + ')')));
		default:
			var r = refinement.a;
			return 'Not (' + ($author$project$Data$Refinement$toString(r) + ')');
	}
};
var $author$project$Data$Template$toString = function (_v0) {
	var _int = _v0.a;
	var list = _v0.b;
	return '[kappa_' + ($elm$core$String$fromInt(_int) + (']_{' + (A2(
		$elm$core$String$join,
		',',
		A2(
			$elm$core$List$map,
...
var $author$project$Data$LiquidType$simpleLiquidTypeToString = function (simpleLiquidType) {
	if (simpleLiquidType.$ === 'IntType') {
		var refinement = simpleLiquidType.a;
		return $author$project$Data$Refinement$toString(refinement);
	} else {
		var template = simpleLiquidType.a;
...
var $author$project$Data$LiquidType$toString = F3(
	function (aToString, bToString, _v0) {
		var list = _v0.a;
		var last = _v0.b;
		return A2(
			$elm$core$String$join,
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						$author$project$Data$LiquidType$simpleformToString(
						bToString(last))
					])));
	});
var $author$project$View$Condition$view = function (_v0) {
	var smaller = _v0.smaller;
	var bigger = _v0.bigger;
	var guards = _v0.guards;
	var typeVariables = _v0.typeVariables;
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($author$project$Data$LiquidType$toString, $author$project$Data$Template$toString, $author$project$Data$LiquidType$simpleLiquidTypeToString, smaller)),
				$mdgriffith$elm_ui$Element$text(' <: '),
				$mdgriffith$elm_ui$Element$text(
				A3($author$project$Data$LiquidType$toString, $author$project$Data$Refinement$toString, $author$project$Data$Template$toString, bigger)),
				$elm$core$List$isEmpty(guards) ? $mdgriffith$elm_ui$Element$none : $mdgriffith$elm_ui$Element$text(
				' with ' + A2(
					$elm$core$String$join,
					',',
					A2($elm$core$List$map, $author$project$Data$Refinement$toString, guards))),
				$elm$core$List$isEmpty(typeVariables) ? $mdgriffith$elm_ui$Element$none : $mdgriffith$elm_ui$Element$text(
				' where ' + A2(
					$elm$core$String$join,
					',',
					A2(
...
var $author$project$View$Condition$viewSimple = function (_v0) {
	var smaller = _v0.smaller;
	var bigger = _v0.bigger;
	var guards = _v0.guards;
	var typeVariables = _v0.typeVariables;
	return $author$project$View$Condition$view(
		{
			bigger: _Utils_Tuple2(_List_Nil, bigger),
			guards: guards,
			smaller: _Utils_Tuple2(_List_Nil, smaller),
			typeVariables: typeVariables
		});
};
var $author$project$Page$Assistant$view = function (model) {
	return _List_fromArray(
		[
			A2(
			$Orasund$elm_ui_widgets$Widget$column,
			$Orasund$elm_ui_widgets$Widget$Style$Material$cardColumn($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
			A2(
				$elm$core$List$map,
				$mdgriffith$elm_ui$Element$column($Orasund$elm_ui_framework$Framework$Grid$simple),
				_List_fromArray(
					[
							...
							function (_v0) {
								...
								return _List_fromArray(
									[
										A2(
										$mdgriffith$elm_ui$Element$el,
										$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$subtitle2,
										$mdgriffith$elm_ui$Element$text(
											'kappa_' + $elm$core$String$fromInt(_int))),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										$elm$core$List$singleton(
											$mdgriffith$elm_ui$Element$text(
												A2(
													...
													A2(
														$elm$core$List$map,
														$author$project$Data$Refinement$toString,
														$elm$core$Array$toList(array))))))
									]);
							},
							$elm$core$Dict$toList(model.predicates))),
						_List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$el,
							$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h6,
							$mdgriffith$elm_ui$Element$text(
								'Is the following SMT statement satisfiable? (' + (function () {
									var _v1 = model.weaken;
									if (_v1.$ === 'Just') {
										var weaken = _v1.a;
										return 'Weaken: part ' + ($elm$core$String$fromInt(weaken.index + 1) + ('/' + $elm$core$String$fromInt(
											A2(
												$elm$core$Maybe$withDefault,
												0,
												A2(
													$elm$core$Maybe$map,
													$elm$core$Array$length,
													A2($elm$core$Dict$get, weaken.liquidTypeVariable, model.predicates))))));
									} else {
										return 'Solve: part ' + ($elm$core$String$fromInt(model.index + 1) + ('/' + $elm$core$String$fromInt(
											$elm$core$Array$length(model.conditions))));
									}
								}() + ')'))),
							A2(
							$elm$core$Maybe$withDefault,
										...
										[
											...
											$Orasund$elm_ui_widgets$Widget$Style$Material$textButton($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
											{
												...
												onPress: $elm$core$Maybe$Just(
													$author$project$Page$Assistant$GotResponse(false)),
												text: 'No'
											}),
											A2(
											$Orasund$elm_ui_widgets$Widget$button,
											$Orasund$elm_ui_widgets$Widget$Style$Material$outlinedButton($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
											{
												icon: $mdgriffith$elm_ui$Element$none,
												onPress: $elm$core$Maybe$Just(
													$author$project$Page$Assistant$GotResponse(true)),
												text: 'Yes'
											})
										]))
								])),
...
var $author$project$Page$Done$view = function (model) {
	return _List_fromArray(
		[
			A2(
			$Orasund$elm_ui_widgets$Widget$column,
							...
							function (_v0) {
								...
								return _List_fromArray(
									[
										...
										$elm$core$List$singleton(
											$mdgriffith$elm_ui$Element$text(
												$author$project$Data$Refinement$toString(r))))
									]);
							},
							$elm$core$Dict$toList(model.predicates)))
					])))
...
var $author$project$Page$Setup$AddCondition = {$: 'AddCondition'};
var $author$project$Page$Setup$AddGuard = {$: 'AddGuard'};
var $author$project$Page$Setup$AddType = {$: 'AddType'};
var $author$project$Page$Setup$AddTypeVariable = {$: 'AddTypeVariable'};
var $author$project$Page$Setup$ChangedBigger = F2(
	function (a, b) {
		return {$: 'ChangedBigger', a: a, b: b};
	});
var $author$project$Page$Setup$ChangedGuard = F2(
	function (a, b) {
		return {$: 'ChangedGuard', a: a, b: b};
	});
var $author$project$Page$Setup$ChangedSmaller = F2(
	function (a, b) {
		return {$: 'ChangedSmaller', a: a, b: b};
	});
var $author$project$Page$Setup$ChangedTypeVariableName = F2(
	function (a, b) {
		return {$: 'ChangedTypeVariableName', a: a, b: b};
	});
var $author$project$Page$Setup$ChangedTypeVariables = F2(
	function (a, b) {
		return {$: 'ChangedTypeVariables', a: a, b: b};
	});
var $author$project$Page$Setup$ChangedVariable = F2(
	function (a, b) {
...
var $author$project$Page$Setup$RemoveTypeVariable = {$: 'RemoveTypeVariable'};
var $author$project$Page$Setup$StartProving = {$: 'StartProving'};
...
var $author$project$Data$LiquidType$formToString = F3(
	function (name, typeVar, form) {
		return _Utils_ap(
			$elm$core$String$concat(
				$elm$core$Array$toList(
					A2(
								...
								return name + ($elm$core$String$fromInt(
									...
									_Utils_ap(
										...
										$elm$core$String$fromInt(
											$elm$core$Array$length(form.a) - i))) + ' -> ')));
							}),
						form.a))),
			$author$project$Data$LiquidType$simpleformToString(
				_Utils_ap(
...
var $Orasund$elm_ui_widgets$Internal$TextInput$textInput = F2(
	function (style, _v0) {
		var chips = _v0.chips;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$List$map,
						$Orasund$elm_ui_widgets$Internal$Button$button(style.chipButton),
						chips)),
					A2(
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonSelectedOpacity = 0.16;
var $Orasund$elm_ui_widgets$Widget$Style$Material$textAndBackground = function (color) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$Font$color(
			$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
				$Orasund$elm_ui_widgets$Widget$Style$Material$Color$accessibleTextColor(color)))
		]);
};
var $Orasund$elm_ui_widgets$Widget$Style$Material$chip = function (palette) {
	return {
					...
					[
						...
						$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
							A3(
								$Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade,
								palette.on.surface,
								$Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonPressedOpacity,
								A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.12, palette.on.surface))))
					])),
				$mdgriffith$elm_ui$Element$focused(
				_List_fromArray(
					[
						...
						$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
							A3(
								$Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade,
								palette.on.surface,
								$Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonFocusOpacity,
								A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.12, palette.on.surface))))
					])),
				$mdgriffith$elm_ui$Element$mouseOver(
				_List_fromArray(
			...
			[
				...
				$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
					A3(
						$Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade,
						palette.on.surface,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonSelectedOpacity,
						A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.12, palette.on.surface)))),
				$mdgriffith$elm_ui$Element$Font$color(
				$Orasund$elm_ui_widgets$Widget$Style$Material$fromColor(
					$Orasund$elm_ui_widgets$Widget$Style$Material$Color$accessibleTextColor(
						A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.12, palette.on.surface)))),
				$mdgriffith$elm_ui$Element$Border$shadow(
				$Orasund$elm_ui_widgets$Widget$Style$Material$Color$shadow(4))
			]),
			...
			_Utils_ap(
				$Orasund$elm_ui_widgets$Widget$Style$Material$textAndBackground(
					A3(
						$Orasund$elm_ui_widgets$Widget$Style$Material$Color$withShade,
						palette.on.surface,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Color$buttonDisabledOpacity,
						A2($Orasund$elm_ui_widgets$Widget$Style$Material$Color$scaleOpacity, 0.12, palette.on.surface))),
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$mouseDown(_List_Nil),
...
var $Orasund$elm_ui_widgets$Widget$Style$Material$textInput = function (palette) {
	return {
		chipButton: $Orasund$elm_ui_widgets$Widget$Style$Material$chip(palette),
...
var $author$project$View$ConditionForm$viewInput = F2(
	function (_v0, text) {
		var label = _v0.label;
		var onChange = _v0.onChange;
		return A2(
			...
			_List_fromArray(
				[
					...
					function (w) {
						...
						$Orasund$elm_ui_widgets$Widget$Style$Material$textInput($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette)),
					{chips: _List_Nil, label: label, onChange: onChange, placeholder: $elm$core$Maybe$Nothing, text: text})
				]));
	});
var $author$project$View$ConditionForm$viewInputArray = F3(
	function (label, onChange, _v0) {
		var tail = _v0.a;
		var head = _v0.b;
		var fun = F2(
			function (index, input) {
				return A2(
					$author$project$View$ConditionForm$viewInput,
					{
						label: _Utils_ap(
							label,
							$elm$core$String$fromInt(
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						A2(
						fun,
						$elm$core$Array$length(tail),
						head)
					])));
	});
var $author$project$View$ConditionForm$viewVarArray = F3(
	function (label, onChange, tail) {
		var fun = F2(
			function (index, input) {
				return A2(
					$author$project$View$ConditionForm$viewInput,
...
var $author$project$View$ConditionForm$viewVarInput = function (_v0) {
	...
	var onValueChange = _v0.onValueChange;
	var name = _v0.name;
	var value = _v0.value;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		...
		_List_fromArray(
			[
				...
				function (w) {
					...
					$Orasund$elm_ui_widgets$Widget$Style$Material$textInput($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette)),
				{chips: _List_Nil, label: 'Name', onChange: onNameChange, placeholder: $elm$core$Maybe$Nothing, text: name}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				function (w) {
					...
					$Orasund$elm_ui_widgets$Widget$Style$Material$textInput($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette)),
				{chips: _List_Nil, label: 'Value', onChange: onValueChange, placeholder: $elm$core$Maybe$Nothing, text: value})
			]));
};
var $author$project$View$ConditionForm$view = F2(
	function (msg, _v0) {
		var smaller = _v0.smaller;
		var bigger = _v0.bigger;
		var guards = _v0.guards;
			...
			_List_fromArray(
				[
					...
					[
						...
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h6,
						$mdgriffith$elm_ui$Element$text('T1 <: T2')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$subtitle2,
						$mdgriffith$elm_ui$Element$text(
							'T1 := ' + A3($author$project$Data$LiquidType$formToString, 'a', 'x', smaller))),
						A3($author$project$View$ConditionForm$viewInputArray, 'x', msg.onChangedSmaller, smaller),
						A2(
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$subtitle2,
						$mdgriffith$elm_ui$Element$text(
							'T2 := ' + A3($author$project$Data$LiquidType$formToString, 'a', 'y', bigger))),
						A3($author$project$View$ConditionForm$viewInputArray, 'y', msg.onChangedBigger, bigger),
						A2(
						$mdgriffith$elm_ui$Element$row,
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$alignRight]),
						_Utils_ap(
							$elm$core$Array$isEmpty(bigger.a) ? _List_Nil : $elm$core$List$singleton(
								A2(
									$Orasund$elm_ui_widgets$Widget$button,
									$Orasund$elm_ui_widgets$Widget$Style$Material$textButton($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.removeType),
										text: 'Remove'
									})),
							_List_fromArray(
								[
									...
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.addType),
										text: 'Add'
									})
								]))),
						$elm$core$Array$isEmpty(bigger.a) ? $mdgriffith$elm_ui$Element$none : A3($author$project$View$ConditionForm$viewVarArray, 'a', msg.onChangedVariable, bigger.a)
					]),
					_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h6,
						$mdgriffith$elm_ui$Element$text('Guards')),
						A2(
						$mdgriffith$elm_ui$Element$column,
						$Orasund$elm_ui_framework$Framework$Grid$simple,
						$elm$core$Array$toList(
										...
										return A2(
											...
											_List_Nil,
											{
												label: $mdgriffith$elm_ui$Element$Input$labelHidden(
													'Guard ' + $elm$core$String$fromInt(index)),
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$alignRight]),
						_Utils_ap(
							$elm$core$Array$isEmpty(guards) ? _List_Nil : $elm$core$List$singleton(
								A2(
									$Orasund$elm_ui_widgets$Widget$button,
									$Orasund$elm_ui_widgets$Widget$Style$Material$textButton($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.removeGuard),
										text: 'Remove'
									})),
							_List_fromArray(
								[
									...
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.addGuard),
										text: 'Add'
									})
								])))
					]),
					...
					[
						...
						$mdgriffith$elm_ui$Element$el,
						$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h6,
						$mdgriffith$elm_ui$Element$text('type variables')),
						A2(
						$mdgriffith$elm_ui$Element$column,
						$Orasund$elm_ui_framework$Framework$Grid$simple,
						$elm$core$Array$toList(
							A2(
								...
								F2(
									function (index, _v1) {
										var name = _v1.a;
										var t = _v1.b;
										return $author$project$View$ConditionForm$viewVarInput(
											{
												name: name,
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$alignRight]),
						_Utils_ap(
							$elm$core$Array$isEmpty(typeVariables) ? _List_Nil : $elm$core$List$singleton(
								A2(
									$Orasund$elm_ui_widgets$Widget$button,
									$Orasund$elm_ui_widgets$Widget$Style$Material$textButton($Orasund$elm_ui_widgets$Widget$Style$Material$defaultPalette),
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.removeTypeVariable),
										text: 'Remove'
									})),
							_List_fromArray(
								[
									...
									{
										icon: $mdgriffith$elm_ui$Element$none,
										onPress: $elm$core$Maybe$Just(msg.addTypeVariable),
										text: 'Add'
									})
								])))
					])
		...
		[
			...
			A2(
				...
				A2(
					...
					$mdgriffith$elm_ui$Element$text('Conditions')),
				_Utils_ap(
					A2($elm$core$List$map, $author$project$View$Condition$view, model.conditions),
					_Utils_ap(
						A2(
							$elm$core$Maybe$withDefault,
							_List_Nil,
						...
						_List_fromArray(
							[
								...
								{
									icon: $mdgriffith$elm_ui$Element$none,
									onPress: model.loaded ? $elm$core$Maybe$Just($author$project$Page$Setup$StartProving) : $elm$core$Maybe$Nothing,
									text: model.loaded ? 'Start Proving' : 'Loading...'
								})
							]))))),
			A2(
			$Orasund$elm_ui_widgets$Widget$column,
				...
				_List_fromArray(
					[
						...
						A2(
							$mdgriffith$elm_ui$Element$el,
							$Orasund$elm_ui_widgets$Widget$Style$Material$Typography$h5,
							$mdgriffith$elm_ui$Element$text('Adding Condition'))),
						A2(
						$author$project$View$ConditionForm$view,
						{addGuard: $author$project$Page$Setup$AddGuard, addType: $author$project$Page$Setup$AddType, addTypeVariable: $author$project$Page$Setup$AddTypeVariable, onChangedBigger: $author$project$Page$Setup$ChangedBigger, onChangedGuard: $author$project$Page$Setup$ChangedGuard, onChangedSmaller: $author$project$Page$Setup$ChangedSmaller, onChangedTypeVariableName: $author$project$Page$Setup$ChangedTypeVariableName, onChangedTypeVariables: $author$project$Page$Setup$ChangedTypeVariables, onChangedVariable: $author$project$Page$Setup$ChangedVariable, removeGuard: $author$project$Page$Setup$RemoveGuard, removeType: $author$project$Page$Setup$RemoveType, removeTypeVariable: $author$project$Page$Setup$RemoveTypeVariable},
						model.form),
						$elm$core$List$singleton(
						A2(
							$mdgriffith$elm_ui$Element$row,
