...
```{block2, type="myexample",latex.options="_"}
$Bool ::= True \ | \ False$ is a valid type application.

$\forall a.List \ a ::= Empty \ | \ Cons \ a \ (List \ a)$ List is a valid quantified type.
```
...
```{block2, type="myexample",latex.options="_"}
\begin{LetIn}T_1:\mathcal{T},T_2:\mathcal{T},T_3:\mathcal{T}\end{LetIn}
...
```{definition,name="Subsets of types"}
