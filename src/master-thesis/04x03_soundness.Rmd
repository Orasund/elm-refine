...
To finish of, we need to prove the soundness of the semantic of expressions. This is by the definition of refinement types trivially true, as the set values of a refinement type is always a subtype of the set of values of the base type.
