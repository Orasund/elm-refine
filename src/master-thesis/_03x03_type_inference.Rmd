...
\begin{letIn}$\Delta_1,\Delta_2$ be type contexts, $a\in\mathcal{V}$. Let $T,T'\in\mathcal{T}$ such that $T'$ is a mono type $\forall c_1 .\dots\forall c_m T' = T$ for some $c_i\in\mathcal{V},i\in\mathbb{N}_0^m$.
\end{letIn}
