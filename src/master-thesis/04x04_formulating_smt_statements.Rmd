...
$$
\begin{aligned}
&c \text{ has the form } \{\nu:\mathit{Int}|[k_1]_S\} <:_{\Theta,\Lambda} \{\nu:\mathit{Int}|[k_2]_S\}\\
\lor &c \text{ has the form } \{\nu:\mathit{Int}|r\} <:_{\Theta,\Lambda} \{\nu:\mathit{Int}|[k_2]_S\}\\
\lor &c \text{ has the form } \{\nu:\mathit{Int}|[k_1]_S\}\to \hat{T}_1 <:_{\Theta,\Lambda} \{\nu:\mathit{Int}|r\}\to \hat{T}_2\\
...
$$
```
The first condition states that $[\hat{T}_1]_S$ and $[\hat{T}_2]_S$ are not templates.
