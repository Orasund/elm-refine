...
In Section \@ref(type-inference) we sad that $\Delta$ is a type context, where as in Section \@ref(denotational-semantic) we said that $\Delta$ is a variable context. We will now define the relation between the two.
...
Types in $\Delta$ are all the most generalized types. Instead of proving this, we show that the semantic only produces values of most generalized types. This is a weaker statement but strong enough for our purposes.
