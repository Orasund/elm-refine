...
\begin{aligned}
   ...
   \mathrm{free}\begin{pmatrix*}[l]
    ...
    \mathrm{free}(a:\hat{T}_1\to \hat{T}_2) :=& \mathrm{free}(\hat{T}_1)\cup\mathrm{free}(\hat{T}_2)
\end{aligned}
$$
...
\mathrm{values}_\Gamma(a:\hat{T}_1\to \hat{T}_2) :=& \mathrm{refinedValues}_{\{\}}(a:\hat{T}_1\to \hat{T}_2)
\end{aligned}
$$
...
$$
\begin{aligned}
\mathrm{refinedValues}_{\Theta}&(a:\hat{T}_1\to \hat{T}_2) :=\\
   &\{b\in \mathrm{values}_{\{\}}(\hat{T}_1 \to \hat{T}_2) |\\
   &\forall n\in \mathrm{values}_{\{\}}(\hat{T}_1).b(n) \in \mathrm{refinedValues}_{\Theta\cup\{(a,n)\}}(\hat{T}_2)\}
\end{aligned}
$$
```