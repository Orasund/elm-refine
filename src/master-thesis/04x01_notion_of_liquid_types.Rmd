...
We will now extend our previous definition of types (see Definition \ref{thm:types}) with the notion of refinement types. This extension is not very interesting, as refinement types don't behave differently from their underlying type.
