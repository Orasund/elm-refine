...
Let $n\in\mathbb{N}$; $\forall j\in\mathbb{N}_1^n k_j\in\mathbb{N}$; ${i\in\mathbb{N}_1^n}$; $\forall j:\mathbb{N}_0^{k_i}.t_j: T_{i,j}$; $T:\mathcal{A}$. For $T ::= C_1 \ T_{1,1} \ .. \ T_{1,k_1} \ | \ .. \ | \ C_n \ T_{n,1} \ .. \ T_{n,k_n}$, we call
