...
There are some liquid types whos values are a subset of the values from another type. In this case we say it is a subtype. For our usecase we will use a different definition of subtyping.
...
\hat{T}_1<:_{\Theta,\Lambda} T_2\quad
