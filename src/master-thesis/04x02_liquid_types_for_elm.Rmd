...
\]\[
  \begin{aligned}
\text{wellFormed}(a:\hat{T}_1\to\hat{T}_2,\Theta) :\Leftrightarrow\\
(a,\_)\not\in \Theta\ \land \ \text{wellFormed}(\hat{T}_1,\Theta)&\ \land\ \text{wellFormed}(\hat{T}_2,\Theta\cup\{(a,\hat{T}_1)\})
\end{aligned}
\]
```
...
\logicRule
{\mathit{lt}_1:_\Theta\hat{T}_1\quad
\mathit{lt}_2:_{\Theta\cup\{(a,\hat{T}_1)\}}\hat{T}_2\quad
(a:\hat{T}_1\rightarrow\hat{T}_2) = \hat{T}_3
}
{a \ \mf{":"} \ \mathit{lt}_1 \ \mf{"->"} \ \mathit{lt}_2:_\Theta\hat{T}_3}
{}
...
\logicRule
{}
{\Gamma,\Delta\vdash\mf{"(+)"}:(a:\mathit{Int}\to b:\mathit{Int}\to\{\nu:\mathit{Int} \ | \ \nu = a + b\})}
{}
...
\logicRule
{}
{\Gamma,\Delta\vdash\mf{"(//)"}:\mathit{Int}\to\{\nu:\mathit{Int} \ | \ \neg (\nu = 0)\}\to\mathit{Int}}
{}
