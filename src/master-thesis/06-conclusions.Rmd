...
In this thesis we have investigated at the type system for the Elm language and discussed its extension by refinement types.
...
Working on this thesis gave insights into the inner workings of liquid types. It showcased its strengths but also its weaknesses. Liquid types are an interesting topic but are no a good fit for the Elm language and the philosophies behind it.
\newpage
