...
\begin{letIn}
$n\in\mathbb{N}$,
$\Theta:\mathcal{V}\nrightarrow\{t\in\mathcal{T}| t is a mono type\}$,
$a\in\mathcal{V}$.
Let $T,T_1,T_2$,
...
\mathrm{values}_\Gamma\small\begin{pmatrix*}[l]
  ...
  \end{matrix*}
  \end{pmatrix*}\\
\small{\mathrm{values}_\Gamma(\{l_1:T_1,\dots,l_n:T_n\})} :=&\Big\{\small{\{l_1=t_1,\dots,l_n=t_n\} \ | \ \forall i\in\mathbb{N}_1^n.t_i \in\mathrm{values}_\Gamma(T_i)}\Big\}\\
