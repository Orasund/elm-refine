...
{
\Gamma_1,\Gamma_2\vdash \syntax{"[" <$p$:pattern> "," <$l$:list-pattern-list> "]"}:\textit{List} \ T_3
}
{P-List}
$$
...
\Gamma_2\vdash \syntax{<$p_1$:pattern>}:T_2
}
{\Gamma_1,\Gamma_2\vdash \syntax{"(" <$p_1$:pattern> "," <$p_2$:pattern> ")"}:T_1 \times T_2}
{P-Tuple}
$$
...
{
\Gamma_1,\Gamma_2\vdash \syntax{<$p_1$:pattern> "::" <$p_2$:pattern>}:\textit{List} \ T_3
}
{P-List}
$$
