...
Elm differenciates between variables depending on the capitalisation of the first letter. For the formal langauge we define `<upper-letter>`$:\mathcal{V}$ for variables with a capitaliced first letter and `<lower-var>`$:\mathcal{V}$ for variables without.
