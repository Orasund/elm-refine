...
{\Gamma,\Delta\vdash\mathtt{"if"} \ e_1  \ \mathtt{"then"} \ e_2 \ \mathtt{"else"} \ e_3:T_0}
$$
...
\frac
{}
{\Gamma,\Delta\cup\{(\mathtt{a},\{\nu:\mathit{Int}| \ r_0\})\},\Theta,\Lambda\vdash \mathtt{a}: \{\nu:\mathit{Int}| \ \nu = a\}}
{}
$$
$$
\frac
{}
{\Gamma,\Delta\cup\{(\mathtt{b},\{\nu:\mathit{Int}| \ r_1\})\},\Theta,\Lambda\vdash \mathtt{b}: \{\nu:\mathit{Int}| \ \nu = b\}}
{}
$$
...
{
\begin{gathered}
\Gamma,\Delta,\Theta,\Lambda\cup\{a<b\}\vdash e_2: \{\nu:\mathit{Int}|r_0\}\\
\Gamma,\Delta,\Theta,\Lambda\cup\{\neg(a<b)\}\vdash e_3: \{\nu:\mathit{Int}|r_0\}
\end{gathered}
}
{\Gamma,\Delta\cup\begin{Bmatrix}(a,\{\nu:\mathit{Int}|r_0\}),\\(b,\{\nu:\mathit{Int}|r_0\})\end{Bmatrix},\Theta,\Lambda\vdash\begin{aligned}\mathtt{"if"} \ \mathtt{a<b}  \ \mathtt{"then"}\\\mathtt{b} \ \mathtt{"else"} \ \mathtt{a}\end{aligned}:\{\nu:\mathit{Int}|r_0\}}
$$
